...
export const Donate = () => {
  const toAfdian = () => {
    window.open('https://afdian.net/a/gomi_gxy/plan');
  }
  return (
          ...
          <div className="flex lg:flex-row flex-col items-center -mx-4 justify-center lg:text-left text-center">
            <div className="w-full lg:w-1/2 px-4 mb-12 lg:mb-0">
              <div className="flex flex-col items-center justify-center">
                ...
                <div onClick={toAfdian} className="w-40 sm:w-40 h-12 mt-5 rounded-md font-bold text-white border border-solid flex justify-center items-center cursor-pointer bg-customPrimary border-customPrimary hover:bg-customSecondary transition">
                  <img className="w-10 h-10 mr-2" src={afdian} />
                  afdian
                </div>
              </div>
            </div>
